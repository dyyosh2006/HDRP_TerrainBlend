...
namespace UnityEditor.Rendering.HighDefinition
{
    ...
    public class LitSurfaceInputsUIBlock : MaterialUIBlock
    {
        ...
        const string ktilingfixedMode = "_NoTilingMode";

        MaterialProperty useTriplanar = null;
        const string kUseTriplanar = "_UseTriplanar";
        MaterialProperty useTriplanarWorldScale = null;
        const string kUseTriplanarWorldScale = "_useTriplanarWorldScale";
        MaterialProperty useTriplanarBlend = null;
        const string kUseTriplanarBlend = "_useTriplanarBlend";
        MaterialProperty usePixelDisplacement = null;
        const string kusePixelDisplacement = "_usePixelDisplacement";
        MaterialProperty usePixelDisplacementHeight = null;
        const string kusePixelDisplacementHeight = "_usePixelDisplacementHeight";
        MaterialProperty usePixelDisplacementSteps = null;
        const string kusePixelDisplacementSteps = "_usePixelDisplacementSteps";
        MaterialProperty usePixelDisplacementRange = null;
        const string kusePixelDisplacementRange = "_usePixelDisplacementRange";
        ...
        public override void LoadMaterialProperties()
        {
            ...
            //sheep yang
            //tiling mode
            tilingfixedMode = FindProperty(ktilingfixedMode);
            //use triplanar
            useTriplanar = FindProperty(kUseTriplanar);
        }
