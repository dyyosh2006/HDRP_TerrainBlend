Shader "HDRP/TerrainLit"
{
    Properties
    {
        ...
        //sheep yang
        [HideInInspector] _NoTilingMode("Tiling Mode", Int) = 0
        [HideInInspector] _UseTriplanar("Use Triplanar", Int) = 0
        [HideInInspector] _useTriplanarWorldScale("Use Triplanar World Scale",Float) = 512
        [HideInInspector] _useTriplanarBlend("Use Triplanar Blend",Range(0.01,20)) = 3
        [HideInInspector] _usePixelDisplacement("Use Pixel Displacement", Int) = 0
        [HideInInspector] _usePixelDisplacementHeight("Use Pixel Displacement Height",Float) = 0
        [HideInInspector] _usePixelDisplacementSteps("Use Pixel Displacement Steps",Range(15,64)) = 15
        //[HideInInspector] _usePixelDisplacementRange("Use Pixel Displacement Range",Range(0,16)) = 5
    }
    ...
    SubShader
    {
        ...
        //Pass
        //{
        //    Name "FeedbackRenderer"
        //    Tags{ "LightMode" = "FeedbackRenderer" }
        ...
        //    #pragma vertex VertFeedbackRenderer
        //    #pragma fragment FragFeedbackRenderer
        ...
        //    #include "Packages/com.unity.render-pipelines.high-definition/Runtime/Material/TerrainLit/TerrainLitTemplate.hlsl"
        //    #include "Packages/com.unity.render-pipelines.high-definition/Runtime/Material/TerrainLit/TerrainLit_Splatmap.hlsl"
        //    #include "Packages/com.unity.render-pipelines.high-definition/Runtime/Material/TerrainLit/TerrainLit_FeedbackRenderer.hlsl"
