namespace UnityEngine.Rendering.HighDefinition
{
    ...
    public static class HDMaterialProperties
    {
        ...
        // sheep yang
        internal const string ktilingfixedMode = "_NoTilingMode";
        internal const string kUseTriplanar = "_UseTriplanar";
        internal const string kUseTriplanarWorldScale = "_useTriplanarWorldScale";
        internal const string kUseTriplanarBlend = "_useTriplanarBlend";
        internal const string kusePixelDisplacement = "_usePixelDisplacement";
        internal const string kusePixelDisplacementHeight = "_usePixelDisplacementHeight";
        internal const string kusePixelDisplacementSteps = "_usePixelDisplacementSteps";
        internal const string kusePixelDisplacementRange = "_usePixelDisplacementRange";

        internal const string kEnableInstancedPerPixelNormal = "_usePixelDisplacementRange";
        // Maps
